...
(function(x) {
  ...
  DEFAULT_SHADOW_COLOR:"rgba(0,0,0,0.5)", DEFAULT_GROUP_FONT:24, WIDGET_BGCOLOR:"#222", WIDGET_OUTLINE_COLOR:"#666", WIDGET_TEXT_COLOR:"#DDD", WIDGET_SECONDARY_TEXT_COLOR:"#999", LINK_COLOR:"#9A9", LINK_HIGHLIGHT_COLOR:"#FFF", EVENT_LINK_COLOR:"#A86", CONNECTING_LINK_COLOR:"#AFA", MAX_NUMBER_OF_NODES:1000, DEFAULT_POSITION:[100, 100], VALID_SHAPES:["default", "box", "round", "card"], BOX_SHAPE:1, ROUND_SHAPE:2, CIRCLE_SHAPE:3, CARD_SHAPE:4, ARROW_SHAPE:5, GRID_SHAPE:6, INPUT:1, OUTPUT:2, EVENT:-1, 
  ACTION:-1, NODE_MODES:["Always", "On Event", "Never", "On Trigger"], NODE_MODES_COLORS:["#666", "#422", "#333", "#224", "#626"], ALWAYS:0, ON_EVENT:1, NEVER:2, ON_TRIGGER:3, UP:1, DOWN:2, LEFT:3, RIGHT:4, CENTER:5, LINK_RENDER_MODES:["Straight", "Linear", "Spline"], STRAIGHT_LINK:0, LINEAR_LINK:1, SPLINE_LINK:2, NORMAL_TITLE:0, NO_TITLE:1, TRANSPARENT_TITLE:2, AUTOHIDE_TITLE:3, VERTICAL_LAYOUT:"vertical", proxy:null, node_images_path:"", debug:!1, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, 
  ...
  slot_types_out:[], slot_types_default_in:[], slot_types_default_out:[], alt_drag_do_clone_nodes:!1, do_add_triggers_slots:!1, allow_multi_output_for_events:!0, middle_click_slot_add_default_node:!1, release_link_on_empty_shows_menu:!1, pointerevents_method:"mouse", registerNodeType:function(a, b) {
    if (!b.prototype) {
  ...
  h.prototype.drawFrontCanvas = function() {
    ...
    if (a) {
      ...
      if (this.graph) {
        ...
        this.dragging_rectangle && (a.strokeStyle = e.LINK_HIGHLIGHT_COLOR, a.strokeRect(this.dragging_rectangle[0], this.dragging_rectangle[1], this.dragging_rectangle[2], this.dragging_rectangle[3]));
  ...
  h.prototype.renderLink = function(a, b, d, f, g, c, k, m, q, u) {
    ...
    null != f && this.highlighted_links[f.id] && (k = e.LINK_HIGHLIGHT_COLOR);
    m = m || e.RIGHT;
    q = q || e.LEFT;
    var n = H(b, d);
  ...
  h.prototype.drawExecutionOrder = function(a) {
    ...
    for (var b = this.visible_nodes, d = 0; d < b.length; ++d) {
      ...
      a.fillStyle = e.LINK_HIGHLIGHT_COLOR;
  ...
  G.prototype.draw = function(a, b, d, c, g, k) {
    if (d = this.points) {
      this.size = b;
      ...
      a.beginPath();
      for (c = 0; c < d.length; ++c) {
        g = d[c], a.lineTo(g[0] * f, (1.0 - g[1]) * b);
      }
      a.stroke();
      a.globalAlpha = 1;
      if (!k) {
        for (c = 0; c < d.length; ++c) {
          g = d[c], a.fillStyle = this.selected == c ? e.LINK_HIGHLIGHT_COLOR : this.nearest == c ? "#DDD" : "#AAA", a.beginPath(), a.arc(g[0] * f, (1.0 - g[1]) * b, 2, 0, 2 * Math.PI), a.fill();
        }
      }
      a.restore();
    }
...
(function(x) {
  ...
  }, z.pixel_shader = "precision highp float;\n\nvarying vec2 v_coord;\nuniform float time; //time in seconds\nuniform vec4 texSize; //tex resolution\nuniform float u_value;\nuniform vec4 u_color;\n\nvoid main() {\n\tvec2 uv = v_coord;\n\tvec3 color = vec3(0.0);\n\t//your code here\n\tcolor.xy=uv;\n\n\tgl_FragColor = vec4(color, 1.0);\n}\n", K.registerNodeType("texture/shader", z), h.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, h.title = "Scale/Offset", h.desc = "Applies an scaling and offseting", 
  h.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  }, H.pixel_shader = "precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform float u_factor;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv += ( texture2D(u_textureB, uv).rg - vec2(0.5)) * u_factor * u_scale + u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t", K.registerNodeType("texture/warp", H), B.title = "to Viewport", B.desc = 
  ...
  B.gamma_pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_igamma;\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord);\n\t\t\tcolor.xyz = pow(color.xyz, vec3(u_igamma) );\n\t\t   gl_FragColor = color;\n\t\t}\n\t\t", K.registerNodeType("texture/toviewport", B), C.title = "Copy", C.desc = "Copy Texture", C.widgets_info = {size:{widget:"combo", values:[0, 32, 64, 128, 256, 512, 1024, 
  ...
  }, J.pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tuniform float u_factor;\n\t\tvarying vec2 v_coord;\n\t\t\n\t\tvoid main() {\n\t\t\tgl_FragColor = mix( texture2D( u_texture, v_coord ), texture2D( u_textureB, v_coord ), u_factor );\n\t\t}\n\t\t", K.registerNodeType("texture/temporal_smooth", J), F.title = "Lineal Avg Smooth", F.desc = "Smooth texture linearly over time", F["@samples"] = {type:"number", 
  ...
  K.registerNodeType("texture/kuwahara", u), w.title = "XDoG Filter", w.desc = "Filters a texture giving an artistic ink style", w.max_radius = 10, w._shaders = [], w.prototype.onExecute = function() {
    ...
    if (a && this.isOutputConnected(0)) {
      ...
      var d = w._xdog_shader, c = GL.Mesh.getScreenQuad(), f = this.properties.sigma, e = this.properties.k, g = this.properties.p, k = this.properties.epsilon, m = this.properties.phi;
      a.bind(0);
      this._temp_texture.drawTo(function() {
        d.uniforms({src:0, sigma:f, k:e, p:g, epsilon:k, phi:m, cvsWidth:a.width, cvsHeight:a.height}).draw(c);
      });
      this.setOutputData(0, this._temp_texture);
    }
  ...
  K.registerNodeType("texture/lensfx", D), S.title = "Data->Tex", S.desc = "Generates or applies a curve to a texture", S.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, S.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      ...
      if (a) {
        ...
        b && b.width == d && b.height == f && b.type == g || (b = this._temp_texture = new GL.Texture(d, f, {type:g, format:e, filter:gl.LINEAR}));
        b.uploadData(a);
        this.setOutputData(0, b);
      }
    }
    ...
    if (this.isOutputConnected(0)) {
      ...
      if (a) {
        ...
        var e = this._uniforms, g = this._curve_texture;
        b.drawTo(function() {
          gl.disable(gl.DEPTH_TEST);
          a.bind(0);
          g.bind(1);
  ...
  K.registerNodeType("texture/tonemapping", N), Q.title = "Perlin", Q.desc = "Generates a perlin noise texture", Q.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}, width:{type:"number", precision:0, step:1}, height:{type:"number", precision:0, step:1}, octaves:{type:"number", precision:0, step:1, min:1, max:50}}, Q.prototype.onGetInputs = function() {
    ...
    if (this.isOutputConnected(0)) {
      ...
      var e = this.getInputOrProperty("persistence"), g = this.getInputOrProperty("octaves"), k = this.getInputOrProperty("offset"), m = this.getInputOrProperty("scale"), h = this.getInputOrProperty("amplitude"), q = this.getInputOrProperty("seed");
      d = "" + a + b + d + e + g + m + q + k[0] + k[1] + h;
      if (d != this._key) {
        this._key = d;
        var l = this._uniforms;
        l.u_persistence = e;
  ...
  b) {
    ...
    var g = this.getInputData(0), k = this.properties, m = this, h = this.graph.getTime(), q = gl, l = gl.canvas;
    ...
    if (q == gl) {
      f.drawTo(function() {
        ...
        try {
          a.draw ? a.draw.call(m, l, q, h, a, g) : a.call(m, l, q, h, a, g), m.boxcolor = "#00FF00";
        } catch (U) {
      ...
      try {
        a.draw ? a.draw.call(this, l, q, h, a, g) : a.call(this, l, q, h, a, g), this.boxcolor = "#00FF00";
      } catch (U) {
